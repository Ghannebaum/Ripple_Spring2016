...
'''
#C:/Users/Skyler/Desktop/RippleFinal/ADSandAFEArduinoSerial.py
...
fstart = open('C:\Users\Skyler\Desktop\RippleFinal\RippleStart.txt', 'r')
fstart.readline
fstart.readline
DataTextFilePath = fstart.readline
ECGCOM = fstart.readline
PPGCOM = fstart.readline
fstart.close
ser = serial.Serial(ECGCOM, 57600, timeout=30)
serPPG = serial.Serial(PPGCOM, 19200, timeout=300000)
